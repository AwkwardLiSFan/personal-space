...
const data = [
  ...
  { number: 'Nov \'21', text: 'P.T., Purgatory and Forgiveness in Visage: A Story Analysis', link: "https://www.gamerswaypoint.com/pt-purgatory-forgiveness-visage-story-analysis/"}
];
